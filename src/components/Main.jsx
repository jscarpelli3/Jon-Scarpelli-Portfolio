  ...
  return (
    <div className="main-div">
      ...
      <div className="project-grid">
        ...
        <div className="project">
          <Project expressCk={false} reactCk={false} jsCk={true} cssCk={true} vueCk={false} postgCk={false} htmlCk={true} mongoCk={false} title={'The Maze Tower'} image={tmtScreen} cap={"A maze adventure game in the style of 80's MS-DOS Freeware"} thumb={"https://the-maze-tower.surge.sh/"} cap2={"This is an original game design featuring a level-creation tool for players to create new gameplay and include it in the base level pack."} git={"https://github.com/jscarpelli3/Jon-Scarpelli_The-Maze-Tower"} git2Check={false} />
        </div>
        <div className="project">
